  ...
  return {
    ...
    init_ww: function (num_workers) {
      ...
      for (let i = 0; i < num_workers; i++) {
        _workers.push(new Worker('recv-worker.2026-05-09T0146.js?v=20260727-220839-safarishare1'));
    ...
    init_video: function (video) {
      ...
      var constraints = {
        audio: false,
        video: {
          width: { min: 720, ideal: idealWidth }, // Request a native camera stream and crop it in the page.
